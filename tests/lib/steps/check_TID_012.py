...
def run_check(json_metadata, browser, food_idx=1):
  json_metadata['TID_012']={}
  json_metadata['TID_012'][TESTFIELD_STATUS] = TEST_TESTING
  ...
  assertCheckPointJotMetadata(json_metadata['TID_012'], browser, 'TID_012_1_{}'.format(food_idx), TEST_ERR_MSG, 0.5)
  ...
  json_metadata['TID_012'][TESTFIELD_STATUS] = TEST_PASS